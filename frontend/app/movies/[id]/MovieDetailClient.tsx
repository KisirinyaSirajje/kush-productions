  ...
  return (
    <>
      ...
      <section className="relative pt-16 sm:pt-20 lg:pt-24">
        {/* Backdrop */}
        <div className="absolute inset-0 h-96 sm:h-[32rem] overflow-hidden">
          <img 
      ...
      <section className="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto space-y-8">
          <RatingInput type="movie" itemId={movie.id} onRatingSubmitted={() => window.location.reload()} />
          <CommentSection type="movie" itemId={movie.id} />
        </div>
      </section>
